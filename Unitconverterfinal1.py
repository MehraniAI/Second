...
value = st.selectbox("Conversion from", ["Year", "Month", "Week", "Day", "Hour", "Minute","Second","Night","Morning","Evening","AM","PM"])
to = st.selectbox("Convert to", ["Year", "Month", "Week", "Day", "Hour", "Minute","Second","Night","Morning","Evening","AM","PM"])
